...
\begin{figure}[h]
	\centering \resizebox{\textwidth}{!}{
	\includegraphics[scale=1,trim=40 210 200 25, clip=true]{Systemarkitektur/Diagrammer/IBD_System_Context.pdf}}
...
\begin{figure}[h]
	\centering \resizebox{\textwidth}{!}{
	\includegraphics[scale=1,trim=25 270 245 20, clip=true]{Systemarkitektur/Diagrammer/IBD_X10_Enhed_Receiver_Light.pdf}}
	\caption{IBD diagram for X.10 enheden i transmitteren}
